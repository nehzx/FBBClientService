...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"0"]) {
        //发送者
        self.chatBackgroudImage.image = [UIImage imageNamed:@"SenderCardNodeBkg" inBundle:Bundle compatibleWithTraitCollection:nil];
        ...
        //接收方
        self.chatBackgroudImage.image = [UIImage imageNamed:@"ReceiverTextNodeBkg" inBundle:Bundle compatibleWithTraitCollection:nil];
        [self.chatBackgroudImage mas_updateConstraints:^(MASConstraintMaker *make) {
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    if (footer == nil) {
        ...
        if (self.dataModel.list.count == 0) {
            ...
            [btn setImage:[UIImage imageNamed:@"set_cell_arrow" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
