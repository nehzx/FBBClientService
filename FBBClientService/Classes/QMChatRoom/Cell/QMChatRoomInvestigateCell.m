...
- (void)createUI {    
    ...
    [_valueButtonOne setBackgroundImage:[UIImage imageNamed:@"contactflag_star_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_valueButtonOne setBackgroundImage:[UIImage imageNamed:@"contactflag_star_select" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [_valueButtonTwo setBackgroundImage:[UIImage imageNamed:@"contactflag_star_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_valueButtonTwo setBackgroundImage:[UIImage imageNamed:@"contactflag_star_select" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [_valueButtonThree setBackgroundImage:[UIImage imageNamed:@"contactflag_star_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_valueButtonThree setBackgroundImage:[UIImage imageNamed:@"contactflag_star_select" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [_valueButtonFour setBackgroundImage:[UIImage imageNamed:@"contactflag_star_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_valueButtonFour setBackgroundImage:[UIImage imageNamed:@"contactflag_star_select" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [_valueButtonFive setBackgroundImage:[UIImage imageNamed:@"contactflag_star_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_valueButtonFive setBackgroundImage:[UIImage imageNamed:@"contactflag_star_select" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
