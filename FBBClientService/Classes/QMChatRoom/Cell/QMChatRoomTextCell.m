...
- (void)createUI {    
    ...
    _textLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:14.0f];
...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"0"]) {
        _textLabel.textColor = [UIColor colorWithRed:42/255.0 green:42/255.0 blue:42/255.0 alpha:1.0];
