...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"0"]) {
        ...
        _voicePlayImageView.image = [UIImage imageNamed:@"SenderVoiceNodePlaying" inBundle:Bundle compatibleWithTraitCollection:nil];
                
        if ([message.status isEqualToString:@"0"]) {
            _secondsLabel.textColor = [UIColor colorWithRed:42/225.0f green:42/225.0f blue:42/225.0f alpha:1];
        ...
        _voicePlayImageView.image = [UIImage imageNamed:@"ReceiverVoiceNodePlaying" inBundle:Bundle compatibleWithTraitCollection:nil];
