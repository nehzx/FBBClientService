...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    _imageView.frame = CGRectMake(10, 10, 80, 80);
    [_imageView sd_setImageWithURL:[NSURL URLWithString:dic[@"img"]] placeholderImage:[UIImage imageNamed:@"qm_default_user" inBundle:Bundle compatibleWithTraitCollection:nil]];
...
//                CGFloat subStrHeight = [QMAlert calculateRowHeight:sub_Title fontSize:12.0 Width:kScreenWidth - 225 - 40];
            ...
            UIImage *image = [UIImage imageNamed:@"SenderCardNodeBkg" inBundle:Bundle compatibleWithTraitCollection:nil];
