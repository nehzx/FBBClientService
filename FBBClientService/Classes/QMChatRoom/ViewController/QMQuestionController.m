...
- (void)viewDidLoad {
    ...
    self.rootView = [[UITableView alloc] initWithFrame:frm style:UITableViewStyleGrouped];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 16, kScreenWidth - 16, 1)];
        line.backgroundColor = [UIColor colorWithRed:241/255.0 green:242/255.0 blue:247/255.0 alpha:1];
