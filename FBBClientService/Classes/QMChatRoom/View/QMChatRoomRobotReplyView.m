...
- (void)createView {
    ...
    [self.noHelpBtn setImage:[UIImage imageNamed:@"qm_useless_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [self.noHelpBtn setImage:[UIImage imageNamed:@"qm_useless_sel" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [self.helpBtn setImage:[UIImage imageNamed:@"qm_useful_nor" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [self.helpBtn setImage:[UIImage imageNamed:@"qm_useful_sel" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
