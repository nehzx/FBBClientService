...
- (void)createView {
    ...
    [self.voiceButton setImage:[UIImage imageNamed:@"ToolBar_Voice" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    self.inputView.tintColor = [UIColor colorWithRed:251/255.0f green:206/255.0f blue:0.0 alpha:1.0];
    self.inputView.textContainerInset = UIEdgeInsetsMake(5, 10, 5, 10);
    ...
    [self.RecordBtn setTitleColor:[UIColor colorWithRed:251/255.0f green:206/255.0f blue:0.0 alpha:1.0] forState:UIControlStateSelected];
    self.RecordBtn.hidden = YES;
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"ToolBar_Emotion" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [self.addButton setImage:[UIImage imageNamed:@"ToolBar_Add" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
- (void)showRecordButton: (BOOL)show {
    if (show) {
        ...
        [self.RecordBtn setTitle:NSLocalizedString(@"button.recorder_normal", nil) forState:UIControlStateNormal];
        [self.voiceButton setImage:[UIImage imageNamed:@"ToolBar_Keyboard" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
- (void)showEmotionView: (BOOL)show {
    if (show) {
        ...
        [self.faceButton setImage:[UIImage imageNamed:@"ToolBar_Keyboard" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
