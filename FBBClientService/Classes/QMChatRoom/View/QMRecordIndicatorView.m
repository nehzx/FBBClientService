...
-(void)createUI {
    ...
    _recordingbackImage.image = [UIImage imageNamed:@"RecordingBkg" inBundle:Bundle compatibleWithTraitCollection:nil];
    [self addSubview:_recordingbackImage];
    
    ///叹号图片
    _markImage = [[UIImageView alloc] init];
    _markImage.frame = CGRectMake(70, 28, 10, 64);
    _markImage.image = [UIImage imageNamed:@"RecordMark" inBundle:Bundle compatibleWithTraitCollection:nil];
    ...
    _volumeImage.image = [UIImage imageNamed:@"RecordingSignal001" inBundle:Bundle compatibleWithTraitCollection:nil];
    ...
    _backImage.image = [UIImage imageNamed:@"RecordCancel" inBundle:Bundle compatibleWithTraitCollection:nil];
...
-(void)updateImageWithPower:(float)power {
    ...
    _volumeImage.image = [UIImage imageNamed:[NSString stringWithFormat:@"RecordingSignal00%d", no] inBundle:Bundle compatibleWithTraitCollection:nil];
}
