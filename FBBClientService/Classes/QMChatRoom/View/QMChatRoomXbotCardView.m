...
- (void)setShopDataDic:(NSDictionary *)dic cellWidth:(CGFloat)cellWidth {
    [_shopImageView sd_setImageWithURL:[NSURL URLWithString:dic[@"img"]] placeholderImage:[UIImage imageNamed:@"qm_default_user" inBundle:Bundle compatibleWithTraitCollection:nil]];
...
- (void)setDataListDic:(NSDictionary *)dic cellWidth:(CGFloat)cellWidth {
    [_listImageView sd_setImageWithURL:[NSURL URLWithString:dic[@"img"]] placeholderImage:[UIImage imageNamed:@"qm_default_user" inBundle:Bundle compatibleWithTraitCollection:nil]];
