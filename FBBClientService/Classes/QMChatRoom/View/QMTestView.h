...
@interface QMTestView : UIView <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UIView *coverView;

@property (nonatomic, strong) UIButton *cancelButton;

@property (nonatomic, copy) void(^peerSelect)(NSDictionary *dic);

- (void)showData:(NSArray *)array title:(NSString *)title;

@end

@interface QMTestCell : UITableViewCell
