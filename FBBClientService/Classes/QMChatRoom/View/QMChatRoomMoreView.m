...
- (void)createView {    
    ...
    [self.takePicBtn setImage:[UIImage imageNamed:@"sharemore_ album" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
//    [self addSubview:self.takeFileBtn];
    ...
    self.evaluateBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width-60*4)/5*2+60, 15, 60, 81);
    
    [self.evaluateBtn setTitle:NSLocalizedString(@"button.chat_evaluate", nil) forState:UIControlStateNormal];
    [self.evaluateBtn setImage:[UIImage imageNamed:@"sharemore_evalue" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [self.questionBtn setImage:[UIImage imageNamed:@"commonProblem" inBundle:Bundle compatibleWithTraitCollection:nil]
                      forState:UIControlStateNormal];
