...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/阿振/FBBClientService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '阿振' => '964190389@qq.com' }
  s.source           = { :git => 'https://github.com/阿振/FBBClientService.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FBBClientService' => ['FBBClientService/Assets/*.png']
  # }
